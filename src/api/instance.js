...
const loginInstance = axios.create(defaultInstance.defaults);
loginInstance.defaults.baseURL += '/auth/login';

export { defaultInstance, groupInstance, voteInstance, invitationInstance, questionInstance, loginInstance };
